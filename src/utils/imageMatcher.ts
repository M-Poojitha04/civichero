...
export function getKeywordSpecificImage(
  ...
  // If you later add park_trail_before.jpg / park_trail_after.jpg,
  ...
  const normalizedCategory =
    CATEGORY_DEFAULT_IMAGES[
      category as keyof typeof CATEGORY_DEFAULT_IMAGES
    ]
      ? (category as keyof typeof CATEGORY_DEFAULT_IMAGES)
      : "Road Issue";
